...
const FailTask = () => {
  return (
    <div className="flex-shrink-0 h-full w-[20%] bg-purple-400 rounded-xl p-5">
      <div className="flex items-center justify-between">
        <h2 className="px-3 py-1 bg-red-700 capitalize text-xl rounded-xl font-semibold">
          high
        </h2>
      ...
      <div className="mt-4">
        <button className="w-full capitalize bg-red-700 px-3 py-1 rounded-sm font-semibold cursor-pointer">
          failed
        </button>
      </div>
    </div>
